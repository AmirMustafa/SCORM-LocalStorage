...
<script type="text/javascript">
    ...
    let scormKey         = 'LearningJournal_http%3A%2F%2Flocalhost%2Fmoodle_mrbs%2Fpluginfile.php%2F59%2Fmod_scorm%2Fcontent%2F1%2Fscormcontent';
    ...
    $.each(localStorage, function(key, value){
        ...
        $.ajax({
            ...
            success: function (res) {
                // alert(localStorageJSON);
                // $("#data").html(localStorageJSON);
                // localStorage.setItem(key, '['+localStorageJSON+']');
            }
        });
        count++;
     }
